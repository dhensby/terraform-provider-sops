...
func getFileData(sourceFile types.String, inputType types.String, svc keyservice.KeyServiceClient) (data map[string]string, raw string, err error) {
	...
	data, raw, err = readData(content, format, svc)
	if err != nil {
...
func getExternalData(source types.String, inputType types.String, svc keyservice.KeyServiceClient) (data map[string]string, raw string, err error) {
